...
void Game::InitPhysics()
{
    ...
    b2Body* groundBody = Box2DHelper::CreateRectangularDynamicBody(phyWorld, 100, 10, 100.0f, 2.5, 0.1f);
    groundBody->SetTransform(b2Vec2(50.0f, 90.0f), 30.0f);

    b2Body* groundBody2 = Box2DHelper::CreateRectangularStaticBody(phyWorld, 100, 10);
    groundBody2->SetTransform(b2Vec2(50.0f, 100.0f), 0.0f);
    ...
    controlBody = Box2DHelper::CreateRectangularDynamicBody(phyWorld, 5, 5, 1.0f, 0.1, 0.0f);
