...
void Game::InitPhysics()
{
    ...
    controlBody = Box2DHelper::CreateRectangularStaticBody(phyWorld, 5, 15);
    controlBody->SetTransform(b2Vec2(15.0f, 90.0f),-150.0f);
}
