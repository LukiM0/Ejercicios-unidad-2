...
{ 
	...
	//OBSTACULOS
	sf::RectangleShape obstacle_1(sf::Vector2f(5, 5));
	groundShape.setFillColor(sf::Color::Yellow);
	groundShape.setPosition(20, 10);
	wnd->draw(obstacle_1);

	sf::RectangleShape obstacle_2(sf::Vector2f(5, 5));
	groundShape.setFillColor(sf::Color::Yellow);
	groundShape.setPosition(35, 25);
	wnd->draw(obstacle_2);

	sf::RectangleShape obstacle_3(sf::Vector2f(5, 5));
	groundShape.setFillColor(sf::Color::Yellow);
	groundShape.setPosition(50, 80);
	wnd->draw(obstacle_3);

	sf::RectangleShape obstacle_4(sf::Vector2f(5, 5));
	groundShape.setFillColor(sf::Color::Yellow);
	groundShape.setPosition(80, 65);
	wnd->draw(obstacle_4);
}
...
void Game::InitPhysics()
{
	...
	b2Body* obstacle_1 = Box2DHelper::CreateRectangularStaticBody(phyWorld, 5, 5);
	obstacle_1->SetTransform(b2Vec2(20.0f,10.0f), 0.0f);

	b2Body* obstacle_2 = Box2DHelper::CreateRectangularStaticBody(phyWorld, 5, 5);
	obstacle_2->SetTransform(b2Vec2(35.0f, 25.0f), 0.0f);

	b2Body* obstacle_3 = Box2DHelper::CreateRectangularStaticBody(phyWorld, 5, 5);
	obstacle_3->SetTransform(b2Vec2(50.0f, 80.0f), 0.0f);

	b2Body* obstacle_4 = Box2DHelper::CreateRectangularStaticBody(phyWorld, 5, 5);
	obstacle_4->SetTransform(b2Vec2(80.0f, 65.0f), 0.0f);

	// Creamos un círculo que controlaremos con el teclado
	controlBody= Box2DHelper::CreateCircularDynamicBody(phyWorld, 5, 1.0f, 0.5, 1.1f);
